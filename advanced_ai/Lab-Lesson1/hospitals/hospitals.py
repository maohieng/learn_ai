        ...
        while maximum is None or count < maximum:
            ...
            for hospital in self.hospitals:
                ...
                for replacement in self.get_neighbors(*hospital):
                    ...
                    # Complete code here: Step1 - Generate neighbor by copying from hospitals' information
                    neighbor = self.hospitals.copy()
                    # Complete code here: Step2 - Remove hospital from neighbor
                    neighbor.remove(hospital)
                    # Complete code here: Step3 - Add "replacement" to neighbor
            ...
            if best_neighbor_cost >= self.get_cost(self.hospitals):
                # Complete code here: Return hospitals
                return self.hospitals
            # Move to a highest-valued neighbor
            else:
                if log:
                    print(f"Found better neighbor: cost {best_neighbor_cost}")
                # Complete code here: Hospitals are equal to the best neighbors by using random choices
...
#hospitals = s.random_restart(10,image_prefix="hospitals", log=True)
